    ...
    <section className="collected-sessions" aria-labelledby="collected-sessions-title">
      ...
      <ul className="collected-session-list">
        {sessions.map((session) => (
          <li key={session.session_id} className="collected-session-item">
            <div className="collected-session-summary">
              <div>
                <p className="collected-session-name">
                  {session.session_name || session.session_id}
                </p>
                <p className="collected-session-meta">
            ...
            <ul className="collected-segment-rows">
              {session.segments.map((segment) => (
                <li key={segment.metadata_filename} className="collected-segment-row">
                  ...
                  <button
                    type="button"
                    onClick={() => void handleDeleteSegment(session.session_id, segment.audio_filename)}
